MODULE sbc_oce
   ...
   REAL(wp), PUBLIC, ALLOCATABLE, SAVE, DIMENSION(:,:) ::   sst_m_con !: mean (nn_fsbc time-step) surface sea con temperature
   [Celsius] ! SLWA calculate conservative sst for river inflow
...
CONTAINS
   ...
   INTEGER FUNCTION sbc_oce_alloc()
      ...
      ALLOCATE( tprecip(jpi,jpj) , sprecip  (jpi,jpj) , fr_i(jpi,jpj) ,   &
         ...
         &      ssu_m  (jpi,jpj) , sst_m    (jpi,jpj) , sst_m_con(jpi,jpj) , frq_m(jpi,jpj) ,  &   ! SLWA
